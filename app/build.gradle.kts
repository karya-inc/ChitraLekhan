...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(project(":chitralekhan"))
...
android {
    namespace = "com.daiatech.chitralekhan.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.daiatech.chitralekhan"
        minSdk = 21
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
compose.desktop {
    application {
        mainClass = "com.daiatech.chitralekhan.app.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.daiatech.chitralekhan.app"
